...
Prototype of program: ./life width heigth iterations

Width and heigth are the dimensions of the board and iterations is the number of iterations of the game of life.
